...
/*	$('.shortcode-instagram.slider-wrapper span.link').not('.show-content').on('click', function(e){
	...
	$(".soc-ico a.share-button.pinterest").click(function(event){
	    ...
	    e.setAttribute('src','https://estrellasdebetta.github.io/web.archive.org/web/20170815035737/http_/assets.pinterest.com/js/pinmarklet.js?r='+Math.random()*99999999);document.body.appendChild(e);
	});
	var mtResizeTimeout;
...
/*
     FILE ARCHIVED ON 03:57:37 Aug 15, 2017 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 00:36:00 Mar 30, 2023.
...
/*
playback timings (ms):
  captures_list: 70.699
  exclusion.robots: 0.106
  exclusion.robots.policy: 0.081
  cdx.remote: 0.056
  esindex: 0.009
  LoadShardBlock: 32.995 (3)
  PetaboxLoader3.datanode: 49.725 (4)
  load_resource: 96.295
  PetaboxLoader3.resolve: 76.501
*/