...
/*	$('.shortcode-instagram.slider-wrapper span.link').not('.show-content').on('click', function(e){
	...
	$(".soc-ico a.share-button.pinterest").click(function(event){
	    ...
	    e.setAttribute('src','https://estrellasdebetta.github.io/web.archive.org/web/20171002182424/http_/assets.pinterest.com/js/pinmarklet.js?r='+Math.random()*99999999);document.body.appendChild(e);
	});
	var mtResizeTimeout;
...
/*
     FILE ARCHIVED ON 18:24:24 Oct 02, 2017 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 00:34:32 Mar 30, 2023.
...
/*
playback timings (ms):
  captures_list: 837.782
  exclusion.robots: 0.068
  exclusion.robots.policy: 0.059
  RedisCDXSource: 0.963
  esindex: 0.01
  LoadShardBlock: 820.541 (3)
  PetaboxLoader3.datanode: 826.975 (4)
  load_resource: 60.828
  PetaboxLoader3.resolve: 42.046
*/