...
/*	$('.shortcode-instagram.slider-wrapper span.link').not('.show-content').on('click', function(e){
	...
	$(".soc-ico a.share-button.pinterest").click(function(event){
	    ...
	    e.setAttribute('src','http://web.archive.org/web/20180330223440/http://assets.pinterest.com/js/pinmarklet.js?r='+Math.random()*99999999);document.body.appendChild(e);
	});
	var mtResizeTimeout;
