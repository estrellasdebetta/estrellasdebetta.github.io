...
/*	$('.shortcode-instagram.slider-wrapper span.link').not('.show-content').on('click', function(e){
	...
	$(".soc-ico a.share-button.pinterest").click(function(event){
	    ...
	    e.setAttribute('src','http://estrellasdebetta.github.io/web.archive.org/web/20190111134334/http_/assets.pinterest.com/js/pinmarklet.js?r='+Math.random()*99999999);document.body.appendChild(e);
	});
	var mtResizeTimeout;
